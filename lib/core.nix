          ...
          options = {
            ...
            mkWrapperExtension = lib.mkOption {
              ...
              description = ''
                ...
                usage `config = config.install.mkWrapperExtension "unique key name" ({ wlib, pkgs, lib, config, ... }: { });`
                ...
                { config, pkgs, lib, ... }: {
                  config = lib.mkMerge [
                    ...
                    (config.install.mkWrapperExtension "unique key name" ({ wlib, pkgs, lib, config, ... }: {
